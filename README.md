...
<div align="center">
  ...
  <h3 align="center">Strapi v4, Nextjs 13, Supabase, Apollo Client Starter Template with Typescript</h3>
...
This repository provides a full-stack application template with Nextjs, Strapi, Apollo-Client, Graphql and Supabase, which allows you to create a fully functional web application with user authentication, database connectivity, and dynamic frontend rendering. The template also uses the `pages` directory in Nextjs for easy routing and building of pages.
...
- [Strapi v4](https://strapi.io/) - a headless CMS that provides database connectivity and user authentication
- [Nextjs 13](https://nextjs.org/) - a React framework that provides server-side rendering and other features for building web applications
- [Supabase](https://supabase.io/) - a cloud database service that provides PostgreSQL database hosting and user authentication
...
5. Install dependencies for Nextjs: `cd ../nextjs && npm install`
6. Start the Nextjs server: `npm run dev`

That's it! You should now be able to access the application at `http://localhost:3000` and strapi server at `http://localhost:1337`
...
- [x] Connect Apollo Client with frontend and backend
- [x] Set up strapi with supabase
...
Distributed under the MIT License. See `LICENSE.txt` in each dir for more information.
...
Carlos Zapata - [@apticus](https://twitter.com/apticus) - czapata@studentflow.io
